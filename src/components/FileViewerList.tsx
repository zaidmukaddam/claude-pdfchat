      ...
      {props.files.length > 0 && (
        <div className="flex flex-col items-left justify-center w-full mt-4">
          <div className="flex flex-row">
            <div
              className="rounded-md flex shadow px-2 py-3 mb-2 w-full bg-gray-50 items-center cursor-pointer border relative "
            ...
            <div className="ml-auto w-max flex items-center justify-center absolute right-2 top-7">
              <ChevronUpIcon
                className={clsx(
